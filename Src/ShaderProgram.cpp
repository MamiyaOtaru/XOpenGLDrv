...
precision lowp int;
	...
	Out << "#define DF_ORMMap " << ShaderDrawFlags::DF_ORMMap << "u" << END_LINE;
	...
	Out << "#define ORMMapIndex " << ORMMapIndex << "u" << END_LINE;
	...
	Out << "#define TMUORMMap Texture" << ORMMapIndex << END_LINE;
