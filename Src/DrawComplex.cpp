...
# endif
	...
	if (safeToReadDepth && !IsSolidBSP && (Surface.PolyFlags & (PF_AlphaTexture | PF_Translucent)))// && IsDepthFadeFX(Surface.Texture->Texture)) // don't fade out "non solid" that is really just unlit
	{
